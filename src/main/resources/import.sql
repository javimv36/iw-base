...
INSERT INTO visita (direccion, importe_estimado, importe_final, terminada, detalles) VALUES ('calle del demonio 666',10,10,true,'Salir a concretar los acuerdos de finanzas');